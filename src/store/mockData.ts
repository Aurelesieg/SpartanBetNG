...
export const MOCK_HISTORY_BETS: any[] = [
  { id: 'h1', homeTeam: 'PSG', awayTeam: 'Dortmund', sport: 'football', prediction: 'PSG gagne', odds: 1.65, stakeAmount: 50, stakePercent: 2.5, timestamp: '14 Juin, 20:45', status: 'won', notes: 'PSG has dominated at home this season. Tactical lineup was superior.', psychologicalTags: ['calculated', 'confident'] },
  { id: 'h2', homeTeam: 'LA Lakers', awayTeam: 'Denver Nuggets', sport: 'basketball', prediction: 'Denver Nuggets gagne', odds: 1.85, stakeAmount: 30, stakePercent: 1.5, timestamp: '13 Juin, 02:00', status: 'won', notes: 'Odds were inflated due to Denver playing back-to-back, but value was still high.', psychologicalTags: ['calculated'] },
  { id: 'h3', homeTeam: 'Novak Djokovic', awayTeam: 'Casper Ruud', sport: 'tennis', prediction: 'Novak Djokovic gagne par 3 sets à 0', odds: 2.10, stakeAmount: 40, stakePercent: 2.0, timestamp: '12 Juin, 14:30', status: 'lost', notes: 'Chose 3-0 set score for extra yield, but Casper Ruud took one sneaky set. Greedy stake choice.', psychologicalTags: ['fomo', 'impulsive'] },
  { id: 'h4', homeTeam: 'Marseille', awayTeam: 'Atalanta', sport: 'football', prediction: 'Plus de 2.5 buts', odds: 1.78, stakeAmount: 50, stakePercent: 2.5, timestamp: '11 Juin, 21:00', status: 'won', notes: 'Both teams are highly offensive. High probability based on past 5 h2h matches.', psychologicalTags: ['calculated', 'disciplined'] },
];